...
public abstract class AbstractReportModel extends AbstractModel {
    ...
    private List<String> exifFilterKeywords = new ArrayList<String>();
    private List<PictureContainer> pictureContainer = new ArrayList<PictureContainer>();
    private final List<PictureParameter> missingExifParameter = new ArrayList<PictureParameter>();
    ...
    /**
     * Constructor with pictureContainer.
     * 
     ...
     * 
     * @param exifParameter
     *            an pictureParameter object whith the combination that is missing.
     */
     ...
     * 
     * @param dataIsCalculated
     *            true if all is ready for getter and false if something is changed and not calculated.
     */
     ...
     */
    public List<String> getExifFilterKeywords() {
     ...
     * 
     * @return the pictureContainer which will be used in report.
     */
     ...
     */
    public List<PictureParameter> getPicturesWithMissingExifParameter() {
