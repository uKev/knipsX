...
public class Category {
     ...
     */
    public Category(final List<Bar> bars, final double minValueX, final double maxValueX) {
     ...
     */
    public Category(final List<Bar> bars, final double minValueX, final double maxValueX, final double minValueZ,
    ...
    /**
     * Setter for the bars. Should only used for Testing.
     * 
     * @param bars
     *            sets the bars.
     */
