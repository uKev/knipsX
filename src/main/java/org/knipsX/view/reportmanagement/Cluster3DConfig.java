...
public class Cluster3DConfig extends AbstractReportCompilation {
    ...
    public Cluster3DConfig() {
        ...
        this.diagramDescription = Messages.getString("Cluster3DConfig.0") + Messages.getString("Cluster3DConfig.1")
                + Messages.getString("Cluster3DConfig.2") + Messages.getString("Cluster3DConfig.3")
                + Messages.getString("Cluster3DConfig.4") + Messages.getString("Cluster3DConfig.5")
