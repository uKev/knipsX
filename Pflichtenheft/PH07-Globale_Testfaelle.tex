...
\subsection{Testfälle für funktionale Anforderungen}
	...
	\subsubsection{Bildmengenmanagement}
		...
		\begin{description}
			...
			\item[/T270/] \textit{Aktivieren eines Eintrags der Inhaltsliste:}\par
		
			\item[/T280/] \textit{Entfernen von Inhalten aus der Inhaltsliste:}\par
		
			\item{/T290/} \textit{Aktivieren/Deaktivieren von Bildern in der Bilderliste einer Bildermenge:}\par
