...
\subsection{Testfälle für funktionale Anforderungen}
	...
	\subsubsection{Programmausführung}
		...
		\begin{description}
			...
			\item[/T020/] \textit{Projekt speichern:}\par Das in \textbf{/T110/} erstellte Projekt wird durch Betätigen der Schaltfläche "`Speichern"' innerhalb der Projektansicht, wie in Kapitel \ref{subsec:projektmanagement} beschrieben, gespeichert. 
