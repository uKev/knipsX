...
\label{subsec:programmausfuehrung}
	...
	\begin{description}
		...
		\item[/F070/] \textit{Namensvergabe Allgemein:}\par	Beim Ausfüllen von Textfeldern gilt allgemein im gesamten Programm es darf der ASCII-Zeichensatz verwendet werden bis auf folgende Zeichen: "`/"', "`\backslash"', "`:"', "`*"', "`?"', "`"'"', "`>"', "`<"', "`|"'.
