...
\label{subsec:diagrammmgmt}
	...
	\begin{description}
		...
		\item[/F330/] \textit{Histogram 3D:}\par
			...
			Dabei wird die xz-Ebene in gleichgroße Rechtecke aufgeteilt. Die y-Achse gibt die Häufigkeit des zu betrachtenden Rechtecks an. Das 3D Histogram kann als \gls{jpg} exportiert werden. Falls n Bildmengen mit der aktuellen Auswertung verbunden sind, so wird jedes Rechteck nochmals in n Rechtecke zerlegt ($ n \in \mathbb{N} $ und $ n>1 $). Das 2D Histogram kann als \gls{jpg} exportiert werden.
