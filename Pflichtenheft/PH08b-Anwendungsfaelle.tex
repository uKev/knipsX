...
\begin{description}
	...
	Hier gilt Allgemein: Wenn Eingaben gemacht werden die nicht korrekt sind, oder nicht alle notwendigen Parameter und Werte bestimmt sind, kann entweder der Vorgang nicht fortgesetzt werden, oder im Endeffekt keine Auswertung erstellt werden. Auf kritische Stellen wird mit einer Markierung und einer Nachricht hingewiesen. Über diverse Vorwärts und Rückwärtsfunktionen ist es auch gut möglich flexibel zu arbeiten und zwischen den folgenden Optionen Hin und Her zu springen. Einen erneuten Einstieg bietet hier der Button "`Öffnen"'.
