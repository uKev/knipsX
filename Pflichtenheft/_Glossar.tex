...
\newglossaryentry{tempX}{name=knipsX,description={Programm},first={Programm}}
...
\newglossaryentry{wilcoxon}{name=Wilcoxon-Mann-Whitney-Test,description={Der Wilcoxon-Test ist ein parameterfreier statistischer Test. Er dient zur Überprüfung der Signifikanz der Übereinstimmung zweier Verteilungen, also ob zwei unabhängige Verteilungen A und B zu derselben Grundgesamtheit gehören. }}
