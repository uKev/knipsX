...
\newglossaryenry{exiftool}{name=Exif Tool,description={Eine verbreitete Referenzimplementierung des Exif-Standards. Die vom Exif Tool gelieferten \gls{exif}-Parameter dienen zum Vergleich mit denen von \gls{tempX}.
