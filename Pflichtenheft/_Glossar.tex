...
\newglossaryenry{exiftool}{name=Exif Tool,description={Eine verbreitete Referenzimplementierung des Exif-Standards. Die vom Exif Tool gelieferten Exif-Parameter dienen zum Vergleich mit denen von knipsX.}}
