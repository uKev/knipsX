...
public class Test {
    ...
    public static void main(String[] args) throws IOException, XMPException {
        ...
        String source = "/home/david/Desktop/DSC00596.JPG";
        ...
        System.out.println(XMPMetaParser.parse(test, null).getPropertyString("http://ns.adobe.com/photoshop/1.0/",
                "subject"));
        System.out.println(XMPMetaParser.parse(test, null).getArrayItem("http://purl.org/dc/elements/1.1/", "subject",
                1));
        System.out.println(XMPMetaParser.parse(test, null).getArrayItem("http://purl.org/dc/elements/1.1/", "subject",
                3));
