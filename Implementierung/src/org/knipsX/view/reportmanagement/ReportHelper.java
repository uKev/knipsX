...
public enum ReportHelper {
    ...
    Boxplot {
        ...
        public JAbstractDiagram<AbstractReportModel> displayDiagram(AbstractReportModel model, int reportID) {
            return new JBoxplot((BoxplotModel) model, reportID);
        }

        public Component getDiagramView() {
            return new JBoxplot(null, -1).getDiagram();
        };
    ...
    Histogram2D {
        ...
        public JAbstractDiagram<AbstractReportModel> displayDiagram(AbstractReportModel model, int reportID) {
            return new JHistogram2D((Histogram2DModel) model, reportID);
        }

        public Component getDiagramView() {
            return new JHistogram2D(null, -1).getDiagram();
        };
    ...
    Histogram3D {
        ...
        public JAbstractDiagram<AbstractReportModel> displayDiagram(AbstractReportModel model, int reportID) {
            return new JHistogram3D((Histogram3DModel) model, reportID);
        }

        public Component getDiagramView() {
            return new JHistogram3D(null, -1).getDiagram();
        };
    ...
    Cluster3D {
        ...
        public JAbstractDiagram<AbstractReportModel> displayDiagram(AbstractReportModel model, int reportID) {
            return new JCluster3D((Cluster3DModel) model, reportID);
        }

        public Component getDiagramView() {
            return new JCluster3D(null, -1).getDiagram();
        };
    ...
    Table {
        ...
        public JAbstractDiagram<AbstractReportModel> displayDiagram(AbstractReportModel model, int reportID) {
            return new JTableDiagram((TableModel) model, reportID);
        }

        public Component getDiagramView() {
            return new JTableDiagram(null, -1).getDiagram();
        };
