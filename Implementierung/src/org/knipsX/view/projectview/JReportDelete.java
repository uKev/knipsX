...
/**
 * Represents the view for a dialog which gives the user the possibility to
 * delete a report.
 */
public class JReportDelete extends JAbstractDialog {
	...
	private void configure() {
		...
		this.jButtonConfirm
				.addActionListener(new DeleteReportConfirmController(
		...
		/* create an action listener (which knows the model) to the button */
		this.jButtonRefuse.addActionListener(new DeleteReportRefuseController(
				this.model));
