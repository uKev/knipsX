...
import org.knipsX.controller.projectview.CopyPictureSetCancelController;
import org.knipsX.controller.projectview.CopyPictureSetOkController;
import org.knipsX.model.AbstractModel;
import org.knipsX.model.projectview.ProjectViewModel;
import org.knipsX.view.JAbstractView;

public class JCopyPictureSet extends JAbstractView {
	...
	public JCopyPictureSet(AbstractModel abstractModel) {
	...
	private JButton getJButtonConfirm() {
		if (this.jButtonConfirm == null) {
			...
			this.jButtonConfirm.addActionListener(new CopyPictureSetOkController(this.model, this));
		}
	...
	private JButton jButtonCancel() {
		if (this.jButtonCancel == null) {
			...
			this.jButtonCancel.addActionListener(new CopyPictureSetCancelController(this.model));
		}
