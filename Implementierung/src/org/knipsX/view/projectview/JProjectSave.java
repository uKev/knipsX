...
public class JProjectSave extends JAbstractDialog {
	...
	private void configure() {
		...
		this.jButtonConfirm.addActionListener(new SaveProjectConfirmController(
				this.model));
		...
		/* create an action listener (which knows the model) to the button */
		this.jButtonRefuse.addActionListener(new SaveProjectRefuseController(
				this.model));
		...
		/* create an action listener (which knows the model) to the button */
		this.jButtonCancel.addActionListener(new SaveProjectCancelController(
				this.model));
